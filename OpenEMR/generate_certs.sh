...
# OpenEMR PoC SSL Certificate Generator
echo "--- OpenEMR PoC SSL Certificate Generator ---"
...
echo "---"
echo "You can now run 'docker-compose up -d' to start OpenEMR via HTTPS on port 8443."
